...
def Plotting_variable(dataframes, variable_name, keyword, output_dir): 
    ...
    plt.axvline(x=100000,label='Equilibration NVE',color='black',linestyle='--',linewidth=2)
    plt.axvline(x=200000,label='Production Run',color='green',linestyle='--',linewidth=2)
